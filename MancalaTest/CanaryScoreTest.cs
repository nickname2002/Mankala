...
namespace MancalaTest
{
    public class CanaryScoreTest
    {
        ...
        public void EmptyRow(int homePitLeft, int[] upper, int[] bottom, int homePitRight, bool expectedResult)
        {
            ...
            IScore scoreStrategy = new CanaryScore();

            //Act 
            Player cPlayer = b.HomePitRight.Owner;
            scoreStrategy.CheckForEmptyRow(new CanaryTurn(), b, cPlayer);
        ...
        { 
            ...
            //Act 
            bool actualResult = scoreStrategy.GameOver(new CanaryTurn(), b);
        ...
        [Theory]
        [InlineData(0, new int[] { 5, 5, 5, 5, 5 }, new int[] { 5, 5, 5, 5, 5 }, 0, false)]
        [InlineData(26, new int[] { 0, 0, 0, 0, 0 }, new int[] { 0, 1, 1, 0, 1 }, 24, true)]
        ...
        {
            CanaryFactory factory = new CanaryFactory();
